...
export function createHive(options) {
    var _a, _b, _c, _d, _e;
    const logger = createHiveLogger((_b = (_a = options === null || options === void 0 ? void 0 : options.agent) === null || _a === void 0 ? void 0 : _a.logger) !== null && _b !== void 0 ? _b : console, '[hive]');
    let enabled = (_c = options.enabled) !== null && _c !== void 0 ? _c : true;
    if (enabled === false) {
        logIf(options.debug === true &&
    ...
    return {
        ...
        [autoDisposeSymbol]: (_e = options.autoDispose) !== null && _e !== void 0 ? _e : true,
        info,
        reportSchema,
        collectUsage,
        collectRequest,
        ...
        experimental__persistedDocuments: options.experimental__persistedDocuments
            ? createPersistedDocuments(Object.assign(Object.assign({}, options.experimental__persistedDocuments), { logger }))
            : null,
    };
}
export const hiveClientSymbol = Symbol('hive-client');
export const autoDisposeSymbol = Symbol('hive-auto-dispose');
