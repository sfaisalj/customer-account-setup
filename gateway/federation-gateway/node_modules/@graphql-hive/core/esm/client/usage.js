...
import { cache, cacheDocumentKey, createHiveLogger, logIf, measureDuration, memo, } from './utils.js';
...
export function createUsage(pluginOptions) {
    ...
    const logger = createHiveLogger((_b = (_a = pluginOptions.agent) === null || _a === void 0 ? void 0 : _a.logger) !== null && _b !== void 0 ? _b : console, '[hive][usage]');
    ...
    const agent = createAgent(Object.assign(Object.assign({}, ((_f = pluginOptions.agent) !== null && _f !== void 0 ? _f : {
        maxSize: 1500,
    })), { logger,
    ...
    logIf(typeof pluginOptions.token !== 'string' || pluginOptions.token.length === 0, 'token is missing', logger.error);
    const shouldInclude = options.sampler && typeof options.sampler === 'function'
        ? dynamicSampling(options.sampler)
        : randomSampling((_h = options.sampleRate) !== null && _h !== void 0 ? _h : 1.0);
    const collectRequest = args => {
        ...
        try {
            ...
            const rootOperation = document.definitions.find(o => o.kind === Kind.OPERATION_DEFINITION);
...
export function createCollector({ schema, max, ttl, processVariables = false, }) {
