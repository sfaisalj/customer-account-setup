...
export async function makeFetchCall(endpoint, config) {
    ...
    return await asyncRetry(async (bail, attempt) => {
        var _a, _b;
        ...
        const response = await ((_b = config.fetchImplementation) !== null && _b !== void 0 ? _b : fetch)(endpoint, {
